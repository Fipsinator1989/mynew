 ...
 * @since Catch Base 1.0
 */
function catchbase_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function catchbase_sanitize_image( $image, $setting ) {
	/*
 ...
 *                    the setting default.
 */
function catchbase_sanitize_number_range( $number, $setting ) {
 ...
 */
function catchbase_sanitize_select( $input, $setting ) {
